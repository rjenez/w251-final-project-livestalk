...
def COCOResult(path: str, name: str = None) -> Data:
	...
	for ann in annotations:
		...
		score = ann['score']
		box = ann['bbox'] if 'bbox' in ann else None
		mask = ann['segmentation'] if 'segmentation' in ann else None
...
def LVIS(path: str = None, name: str = None, version_str: str = 'v1', force_download: bool = False) -> Data:
	...
	during mAP calculation and errors processing, so adding a bunch of them doesn't hurt.
